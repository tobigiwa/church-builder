...
const FrameComponent: FunctionComponent = () => {
  ...
  return (
    <div className="relative w-full h-[6786px] flex flex-col items-end justify-start text-center text-base text-primary-black-100 font-public-sans">
      <div className="self-stretch flex-1 [background:linear-gradient(28.44deg,_#0d43df,_#fff)] overflow-hidden flex flex-col items-center justify-between text-left text-mid text-night-ghost-text md:pt-0 md:box-border">
      ...
      <div className="self-stretch flex-1 [background:linear-gradient(#fff,_#fff),_#f0f0f2] flex flex-row items-center justify-center">
            ...
            <div className="w-[380px] h-[617px] flex flex-col items-center justify-center gap-[15px] text-7xs-7 font-roboto-condensed">
              <div className="relative bg-lightpink w-[380px] h-[543px] overflow-hidden shrink-0">
                <div className="absolute h-[63.72%] w-9/12 top-[6.08%] right-[-3.69%] bottom-[30.2%] left-[28.69%] bg-night-ghost-text shadow-[30px_11px_24px_rgba(0,_0,_0,_0.25)] overflow-hidden">
                  ...
                  <b className="absolute top-[128.96px] left-[32.44px] text-[17.1px] tracking-[-0.01em] leading-[22.8px] uppercase text-gray-300">
                    <p className="m-0">{`THE benefits of joining `}</p>
                    <p className="m-0">our church</p>
                  </b>
                  <div className="absolute top-[190.94px] left-[33.5px] text-[8.55px] tracking-[-0.01em] leading-[10.87px] lowercase text-dimgray-200">
                    <p className="m-0">
                ...
                <div className="absolute h-[55.2%] w-[34.6%] top-[41.44%] right-[63.95%] bottom-[3.37%] left-[1.44%] bg-night-ghost-text shadow-[12px_22px_24px_rgba(0,_0,_0,_0.25)] overflow-hidden text-[5.91px]">
                  ...
                  />
                  <b className="absolute top-[58.69px] left-[9.97px] text-[11.81px] tracking-[-0.01em] leading-[13.66px] uppercase text-gray-300">
                  ...
                  <div className="absolute top-[90.06px] left-[9.97px] text-[5.17px] tracking-[-0.01em] leading-[7.2px] lowercase text-dimgray-200">
                    <p className="m-0">
                      find fulfillment and joy by joining us on
                    </p>
                    <p className="m-0">Sunday service and weekly service.</p>
      ...
      <div className="self-stretch bg-aliceblue h-[1131px] overflow-hidden shrink-0 flex flex-row py-[30px] px-0 box-border items-center justify-between font-label-medium-600">
      ...
      <div className="self-stretch flex-1 bg-royalblue-100 overflow-hidden flex flex-col py-[108px] px-0 items-center justify-start text-21xl text-night-ghost-text font-label-medium-600">
      ...
      <div className="self-stretch flex-1 bg-night-ghost-text flex flex-col py-[50px] px-0 items-center justify-start gap-[100px]">
        ...
        <div className="self-stretch flex-1 flex flex-col py-5 px-10 items-start justify-center gap-[20px] text-left text-17xl text-gray-400">
          <div className="self-stretch flex flex-col py-1 px-0 items-start justify-start gap-[10px]">
            ...
            <div className="self-stretch relative text-base leading-[18px] font-label-medium-600 text-dimgray-100 flex items-center h-5 shrink-0">
          ...
          <div className="self-stretch flex-1 overflow-hidden flex flex-row items-center justify-center gap-[20px] flex-wrap text-base">
            <div className="flex flex-col items-start justify-start gap-[20px]">
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  <b className="absolute top-[19px] left-[20px] tracking-[-0.4px] leading-[19.2px] flex items-center w-[71.47px] h-5">
                    Autosave
                  </b>
                  <div className="absolute top-[51.18px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[145.36px] h-[15px]">
              ...
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[125.4px] h-[15px]">
              ...
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[118.93px] h-[15px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[20px]">
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.18px] left-[20px] text-[12.5px] leading-[20px] text-dimgray-100 flex items-center w-[113.86px] h-[15px]">
                    or yourdomain.com
                  </div>
                </div>
              </div>
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[104.37px] h-[15px]">
                    Secured with SSL
                  </div>
                </div>
              </div>
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[81.9px] h-[15px]">{`Fast & Secure`}</div>
                </div>
              </div>
            </div>
            <div className="flex flex-col items-start justify-start gap-[20px]">
              <div className="rounded-3xs overflow-hidden flex flex-col items-start justify-start">
                <div className="relative rounded-3xs bg-whitesmoke-300 w-[300px] h-[89.19px]">
                  <b className="absolute top-[19px] left-[20px] tracking-[-0.4px] leading-[19.2px] flex items-center w-[99.87px] h-5">
                    Multiple sites
                  </b>
                  <div className="absolute top-[51.18px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[101.11px] h-[15px]">
                    One account
                  </div>
                </div>
              </div>
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[113.48px] h-[15px]">
                    Super simple setup
                  </div>
                </div>
              </div>
              <div className="rounded-3xs w-[300px] overflow-hidden flex flex-col items-start justify-start">
                <div className="self-stretch relative rounded-3xs bg-whitesmoke-300 h-[89.19px]">
                  ...
                  <div className="absolute top-[51.19px] left-[20px] text-xs leading-[20px] text-dimgray-100 flex items-center w-[142.11px] h-[15px]">
      ...
      <div className="self-stretch flex-1 bg-night-ghost-text flex flex-row items-center justify-center text-19xl text-gray-400">
        <div className="flex-1 flex flex-col py-[50px] px-5 items-center justify-center gap-[20px]">
          ...
          <div className="self-stretch overflow-hidden flex flex-row items-center justify-between max-w-[680px] text-left text-base">
            <div className="self-stretch flex-1 flex flex-col pt-0 px-0 pb-2.5 items-center justify-center gap-[10px]">
              <div className="self-stretch rounded-3xs bg-whitesmoke-300 h-[60px] flex flex-row py-0 px-5 box-border items-center justify-between">
