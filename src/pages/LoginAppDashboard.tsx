      ...
      <div className="self-stretch [background:linear-gradient(180deg,_#91a8ea,_#fff)] overflow-hidden flex flex-col py-28 px-0 items-center justify-start gap-[109px] md:pt-20 md:pb-20 md:box-border">
        ...
        <div className="self-stretch flex flex-row items-center justify-center">
          <div className="rounded-mid bg-white shadow-[6px_6px_25px_7px_rgba(157,_157,_157,_0.15)] w-[250px] h-[250px] overflow-hidden shrink-0 flex flex-col pt-[68px] pb-[54px] pr-[54.00001525878906px] pl-[54px] box-border items-center justify-center gap-[32px]">
            ...
            <div className="rounded-lg bg-royalblue-100 box-border w-[168px] h-[54px] overflow-hidden shrink-0 flex flex-row pt-[20.3700008392334px] pb-[20.3799991607666px] pr-[33.499996185302734px] pl-[32.380001068115234px] items-center justify-center text-xs text-white border-[2px] border-solid border-white">
